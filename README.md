...
项目理念：**科技向善**。我们希望 AI 不只提升效率，也真正提升家庭沟通的安全感与幸福感。

## 核心亮点

- iPhone 实时语音识别（普通话 / 粤语）+ 低延迟传输到 iPad
- iPad 大字流式阅读界面，适配老年人高可读需求
- 端侧文本清洁能力，尽量保留时间、药量、地点等关键事实
- Apple 生态双端协同（iPhone + iPad）与工程化交付（Xcode）
